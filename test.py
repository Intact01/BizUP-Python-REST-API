...
response = requests.get(
    BASE,{"src": "https://storage.googleapis.com/bizupimg/profile_photo/918208896427%20GOODWELL%20LOGO.png"})
print(response.json())
response = requests.get(
    BASE, {"src": "https://storage.googleapis.com/bizupimg/profile_photo/WhatsApp%20Image%202020-08-23%20at%203.11.46%20PM%20-%20Himanshu%20Kohli.jpeg"})
print(response.json())
response = requests.get(
